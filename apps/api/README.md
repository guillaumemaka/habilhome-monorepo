...
- 🛠&nbsp;&nbsp;&nbsp;[`koa-passport`][koa-passport] for authentication framework.
- 👮‍♀️&nbsp;&nbsp;&nbsp;[`passport-jwt`][passport-jwt] for authentication method.
...
- 📄 &nbsp;&nbsp;&nbsp;[`dotenv`][yenv] for environment variable management.
...
Define all your environment variables in `.env`
...
- Guillaume Maka - [@guillaumemaka](https://twitter.com/guillaumemaka)
